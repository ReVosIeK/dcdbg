...
//            // Wywołaj funkcję obrony i ZAPISZ JEJ WYNIK do zmiennej
//            const isDefended = await engine.applyCardEffect('defense_reveal:villain_or_supervillain_from_hand', gameState, player, {})zzzz;
//
//            // Uruchom główny efekt ataku TYLKO WTEDY, gdy obrona się nie powiodła
//            if (!isDefended) {
//                if (player.hand.length <= 2) {
...
/*        case 'each_player_reveals_hand_then_chooses_1_card_cost_ge_1_from_hand_and_adds_to_lineup': {
            ...
            if (cardIndex !== -1) {
                ...
                // POPRAWKA: Zamiast szukać pustego miejsca, po prostu dodajemy kartę
