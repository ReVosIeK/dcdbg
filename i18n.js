...
const translations = {
    pl: {
        ...
        // === DZIENNIK ZDARZEŃ ===
        log_panel_tooltip: "Dziennik Zdarzeń",
        log_panel_title: "Dziennik Zdarzeń",
        log_player_plays: "Gracz zagrywa:",
        log_player_buys: "Gracz kupuje:",
        log_player_defeats: "Gracz pokonuje:",
        log_ai_buys: "AI kupuje:",
        log_ai_defeats: "AI pokonuje:",
        log_turn_starts: "Rozpoczyna się tura:",
        log_ai_turn_ends: "Tura AI się kończy.",
        log_ai_draws_hand: "AI dobrało nową rękę.",
        log_ai_generated_power: "AI wygenerowało:",
        log_player_defended: "Gracz obronił się za pomocą:",
        log_attack_unblocked: "Atak trafia! Gracz nie obronił się.",
        log_super_villain_appears: "Pojawia się nowy Super-złoczyńca:",
        log_cleanup_effect: "{CARD_NAME}: Efekt sprzątania, karta trafia na spód talii.",
        log_blue_beetle_defense: "Blue Beetle obronił atak. Karta pozostaje na ręce.",
        log_man_of_steel_effect: "Man of Steel przeniósł {COUNT} Supermoce na rękę.",
        log_zatanna_effect: "Zatanna przeniosła {COUNT} karty na spód talii.",
        log_dark_knight_equip_gain: "Mroczny Rycerz zdobywa {COUNT} Ekwipunki.",
        log_cards_destroyed: "Zniszczono {COUNT} kart(y).",
        log_nth_metal_destroy: "Nth Metal zniszczył kartę {CARD_NAME} z wierzchu talii.",
        log_nth_metal_keep: "Nth Metal pozostawił kartę {CARD_NAME} na wierzchu talii.",
        log_emerald_knight_borrow: "Szmaragdowy Wojownik pożycza {CARD_NAME} z Line-Up.",
        log_jonn_jonzz_play: "J'onn J'onzz zagrywa {CARD_NAME}...",
        log_parallax_effect: "Parallax aktywowany: Moc w tej turze zostanie podwojona.",
        log_joker_solo: "Efekt Jokera: Brak przeciwników w trybie solo.",
        log_anti_monitor_destroy: "Anti-Monitor zniszczył {COUNT} kart(y) z Line-Up.",
        log_dark_knight_combo: "Kombinacja Mrocznego Rycerza: Przeniesiono {COUNT} kart(y) na rękę.",
        log_ai_ability_usage: "AI używa zdolności {ABILITY_SOURCE}, by położyć {CARD_NAME} na wierzchu swojej talii.",
        log_ai_solomon_grundy: "AI używa zdolności Salomona Grundy'ego, by położyć go na wierzchu swojej talii.",
        log_ai_trident: "AI używa Trójzębu Aquamana, by położyć {CARD_NAME} na wierzchu swojej talii.",
        player_label: "Gracz",
    ...
    en: {
        ...
        // === EVENT LOG ===
        log_panel_tooltip: "Event Log",
        log_panel_title: "Event Log",
        log_player_plays: "Player plays:",
        log_player_buys: "Player buys:",
        log_player_defeats: "Player defeats:",
        log_ai_buys: "AI buys:",
        log_ai_defeats: "AI defeats:",
        log_turn_starts: "Turn starts:",
        log_ai_turn_ends: "AI turn ends.",
        log_ai_draws_hand: "AI drew a new hand.",
        log_ai_generated_power: "AI generated:",
        log_player_defended: "Player defended with:",
        log_attack_unblocked: "The attack hits! Player did not defend.",
        log_super_villain_appears: "A new Super-Villain appears:",
        log_cleanup_effect: "{CARD_NAME}: Cleanup effect, card moves to the bottom of the deck.",
        log_blue_beetle_defense: "Blue Beetle defended the attack. The card remains in hand.",
        log_man_of_steel_effect: "Man of Steel moved {COUNT} Super Powers to hand.",
        log_zatanna_effect: "Zatanna moved {COUNT} cards to the bottom of the deck.",
        log_dark_knight_equip_gain: "Dark Knight gains {COUNT} Equipment.",
        log_cards_destroyed: "Destroyed {COUNT} card(s).",
        log_nth_metal_destroy: "Nth Metal destroyed {CARD_NAME} from the top of the deck.",
        log_nth_metal_keep: "Nth Metal left {CARD_NAME} on top of the deck.",
        log_emerald_knight_borrow: "Emerald Knight borrows {CARD_NAME} from the Line-Up.",
        log_jonn_jonzz_play: "J'onn J'onzz is playing {CARD_NAME}...",
        log_parallax_effect: "Parallax activated: Power will be doubled this turn.",
        log_joker_solo: "Joker's effect: No opponents in solo mode.",
        log_anti_monitor_destroy: "Anti-Monitor destroyed {COUNT} card(s) from the Line-Up.",
        log_dark_knight_combo: "Dark Knight Combo: Moved {COUNT} card(s) to hand.",
        log_ai_ability_usage: "AI uses {ABILITY_SOURCE}'s ability to place {CARD_NAME} on top of its deck.",
        log_ai_solomon_grundy: "AI uses Solomon Grundy's ability to place him on top of its deck.",
        log_ai_trident: "AI uses Aquaman's Trident to place {CARD_NAME} on top of its deck.",
        player_label: "Player",
